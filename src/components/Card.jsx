...
<div className='text-lg font-bold text-black-500'>Rs {price}/-</div>
<div className='flex justify-center items-center gap-2 text-red-500 text-lg font-semibold'>{type==="veg"?<LuLeafyGreen />:<GiChickenOven />} <span>{type}</span></div>
      ...
      <button className='w-full p-3 rounded-lg bg-red-500 text-white hover:bg-red-400 transition-all' onClick={()=>{dispatch(AddItem({id:id, name:name,price:price,image:image,qty:1}));
